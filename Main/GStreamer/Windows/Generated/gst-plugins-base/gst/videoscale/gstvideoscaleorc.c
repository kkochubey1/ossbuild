...
#ifdef DISABLE_ORC
void
orc_merge_linear_u8 (orc_uint8 * d1, const orc_uint8 * s1, const orc_uint8 * s2, int p1, int n){
  int i;
...
#ifdef DISABLE_ORC
void
orc_merge_linear_u16 (orc_uint16 * d1, const orc_uint16 * s1, const orc_uint16 * s2, int p1, int p2, int n){
  int i;
...
gst_videoscale_orc_downsample_yuyv (guint8 * d1, const guint8 * s1, int n){
  ...
  for (i = 0; i < n; i++) {
    ...
    /* 6: mergebw */
    var39.x2[0] = ((orc_uint8)var44.x2[0] & 0x00ff) | ((orc_uint8)var47.x2[0] << 8);
    var39.x2[1] = ((orc_uint8)var44.x2[1] & 0x00ff) | ((orc_uint8)var47.x2[1] << 8);
    /* 7: storel */
    ptr0[i] = var39;
  }
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_resample_nearest_u8 (guint8 * d1, const guint8 * s1, int p1, int p2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  orc_int8 var32;
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_resample_bilinear_u8 (guint8 * d1, const guint8 * s1, int p1, int p2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  orc_int8 var32;
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_resample_nearest_u32 (guint8 * d1, const guint8 * s1, int p1, int p2, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var32;
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_resample_bilinear_u32 (guint8 * d1, const guint8 * s1, int p1, int p2, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var32;
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_resample_merge_bilinear_u32 (guint8 * d1, guint8 * d2, const guint8 * s1, const guint8 * s2, int p1, int p2, int p3, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_merge_bicubic_u8 (guint8 * d1, const guint8 * s1, const guint8 * s2, const guint8 * s3, const guint8 * s4, int p1, int p2, int p3, int p4, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;

...
#ifdef DISABLE_ORC
void
orc_merge_linear_u8 (uint8_t * d1, const uint8_t * s1, const uint8_t * s2, int p1, int p2, int n){
  int i;
  int8_t var0;
  int8_t * ptr0;
  int8_t var4;
...
#ifdef DISABLE_ORC
void
orc_merge_linear_u16 (uint16_t * d1, const uint16_t * s1, const uint16_t * s2, int p1, int p2, int n){
  int i;
  int16_t var0;
  int16_t * ptr0;
  int16_t var4;
  ...
  for (i = 0; i < n; i++) {
    ...
    ptr5++;
    /* 0: muluwl */
    var32.i = (uint16_t)var4 * (uint16_t)var24;
    /* 1: muluwl */
    var33.i = (uint16_t)var5 * (uint16_t)var25;
    /* 2: addl */
    var34.i = var32.i + var33.i;
    /* 3: shrul */
    var35.i = ((uint32_t)var34.i) >> var16;
    /* 4: convlw */
    var0 = var35.i;
    *ptr0 = var0;
    ptr0++;
